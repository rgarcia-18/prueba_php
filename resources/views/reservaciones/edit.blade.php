    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                    ...
                    <h3 class="box-title">{{trans('adminlte::adminlte.editarReserva')}}</h3>
            </div>	
            <form id="form-obj" role="form" method="post" action="{{route('reservaciones.modification')}}">
                {{csrf_field()}}
                <div class="box box-default">
                    ...
                    <div class="box-body">                        
                        <div class="form-group col-xs-10 col-sm-4 col-md-6 col-lg-6">
                            ...
                            <input type="text" value="{{ \Carbon\Carbon::parse($reservacion->fecha)->format('d/m/Y') }}" autocomplete="off" class="form-control" id="fecha" name="fecha" placeholder="{{ trans("adminlte::adminlte.fecha") }}"  maxlength="255">
                        </div>
                        <div class="form-group col-xs-10 col-sm-4 col-md-6 col-lg-6">
                            <label for="numPersonas">{{ trans("adminlte::adminlte.numPersonas") }}</label>
                            <input type="number" value="{{$reservacion->num_personas}}" class="form-control" id="numPersonas" name="numPersonas" placeholder="{{ trans("adminlte::adminlte.numPersonas") }}" maxlength="255">
                        </div>
                        ...
                        <div class="form-group col-xs-10 col-sm-4 col-md-6 col-lg-6">
                            ...
                            <select class="form-control fila" name="usuario" id="usuario" required="required">
                                ...
                                @foreach($users as $user)
                                    <option @if($user->id == $reservacion->id_user) selected="selected" @endif value="{{$user->id}}">{{$user->name}} {{$user->lastName}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="clearfix"></div>    
                        ...
                        <input type="hidden" name="countButacas" id="countButacas" value="{{count($butacas)}}">
